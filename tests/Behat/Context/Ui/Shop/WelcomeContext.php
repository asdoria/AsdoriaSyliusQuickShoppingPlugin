...
namespace Tests\Asdoria\SyliusQuickShoppingPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\Asdoria\SyliusQuickShoppingPlugin\Behat\Page\Shop\WelcomePageInterface;
